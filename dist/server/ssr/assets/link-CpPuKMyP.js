import { C as stripBasePath, S as hasBasePath, T as __toESM, _ as withBasePath$1, a as getMountedSlotsHeader, b as require_react, c as prefetchRscResponse, d as createRscRequestHeaders, f as createRscRequestUrl, g as toSameOriginAppPath, h as toBrowserNavigationHref, m as resolveRelativeHref, o as getPrefetchedUrls, r as getCurrentInterceptionContext, s as navigateClientSide, t as require_jsx_runtime, v as isDangerousScheme, x as VINEXT_MOUNTED_SLOTS_HEADER, y as AppElementsWire } from "../index.js";
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onMouseEnter, onTouchStart, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-tJrMxm2z.js")).default;
...
//#endregion
export { addLocalePrefix as a, urlQueryToSearchParams as i, addQueryParam as n, getDomainLocaleUrl as o, appendSearchParamsToUrl as r, Link as t };
